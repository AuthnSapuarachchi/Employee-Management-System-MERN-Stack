...
import { FaUser, FaEnvelope, FaPhone, FaBriefcase, FaBuilding, FaMoneyBillWave, FaCalendarAlt, FaSave, FaTimes } from 'react-icons/fa'
import Sidebar from '../Dashboard/Sidebar'
import { fetchDepartments, addEmployee, validateEmployeeData } from '../../utils/EmployeeHelper'
...
const AddEmployee = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true)
    try {
      // Use helper function to add employee
