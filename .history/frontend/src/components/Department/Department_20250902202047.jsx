...
const Department = () => {
  ...
  console.log('Rendering department list, departments:', departments); // Debug log

  return (
    <div className="p-6">
      <div style={{ marginBottom: '20px', padding: '10px', backgroundColor: '#f0f0f0' }}>
        DEBUG: Department component is rendering. Departments count: {Array.isArray(departments) ? departments.length : 'NOT AN ARRAY'}
      </div>
      {/* Header */}
        ...
        <div className="bg-white rounded-xl shadow-lg p-4 border border-gray-100">
          <div className="flex items-center">
            ...
            <div className="ml-3">
              ...
              <p className="text-2xl font-bold text-gray-900">{Array.isArray(departments) ? departments.length : 0}</p>
            </div>
          </div>
        </div>
          ...
          <div className="flex items-center">
            ...
            <div className="ml-3">
              ...
              <p className="text-2xl font-bold text-gray-900">
                {Array.isArray(departments) ? departments.reduce((sum, dept) => sum + (dept.employeeCount || 0), 0) : 0}
              </p>
            </div>
          </div>
        </div>
